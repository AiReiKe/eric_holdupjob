...
local resourceName = "eric_holdupjob"

local GetRepoInformations = function()
    local repoVersion, repoURL, repoBody = nil, nil, nil

    PerformHttpRequest("https://api.github.com/repos/AiReiKe/eric_holdupjob/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://github.com/AiReiKe/eric_holdupjob"
        end
    end, "GET")
...
CreateThread(function()
    if GetCurrentResourceName() ~= "eric_holdupjob" then
        resourceName = "eric_holdupjob (" .. GetCurrentResourceName() .. ")"
    end
    PerformHttpRequest("https://api.github.com/repos/AiReiKe/eric_holdupjob/releases/latest", CheckVersion, "GET")
end)